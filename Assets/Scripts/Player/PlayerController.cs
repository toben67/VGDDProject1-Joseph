...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("A list of all attacks and inform about them")]
   ...
   //The move direction of the player. DOES NOT include magniture.
   ...
   #region Initilization
    private void Awake()
    {
        ...
        for(int i = 0; i < m_Attacks.Length; i++)
        {
            ...
            if (attack.WindUpTime > attack.FrozenUpTime)
            {
    ...
    private void Update()
    {
        ...
        for(int i = 0; i < m_Attacks.Length; i++)
        {
            ...
            if(attack.IsReady())
            {
                ...
                {
                    p_FrozenTimer = attack.FrozenUpTime;
   ...
   public void DecreaseHealth(float amount)
    {
        p_cureHealth -= amount;
        m_HUD.UpdateHealth(1.0f - p_cureHealth/m_MaxHeath);
        if (p_cureHealth <= 0)
        {
